...
VOLTAGE_DROP_SMALL_LOAD_V_PER_KM = CONFIG_GRID["VOLTAGE_DROP_SMALL_LOAD_V_PER_KM"]
VOLTAGE_DROP_LARGE_LOAD_V_PER_KM = CONFIG_GRID["VOLTAGE_DROP_LARGE_LOAD_V_PER_KM"]
