...
* Other countries can be added by two steps:
  ...
  1. Replacing the data preprocessing pipeline (e.g., see a parallel project working on the `US-pipeline <https://github.com/DAI-Lab/Gridtracer>`_)
...
* **Census Demographics (Zensus 2022)**: Official population data for precise household-to-building allocation
* **Cadastral Geodata**: Official street networks with addresses and administrative boundaries
* **Building Classification**: Automated building type classification based on geometry and demographic data
